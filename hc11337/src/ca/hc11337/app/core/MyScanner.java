...
/**
 * A simple text MyScanner which can parse primitive types and strings using
 * regular expressions.
 *
 ...
 *      }</pre></blockquote>
 *
 * <p>The MyScanner can also use delimiters other than whitespace. This 
 ...
 * by a MyScanner is as recognized by {@link java.lang.Character}.{@link
 * java.lang.Character#isWhitespace(char) isWhitespace}. The {@link #reset}
 * method will reset the value of the MyScanner's delimiter to the default
 ...
 *
 * <p>When a MyScanner throws an {@link InputMismatchException}, the MyScanner
 ...
 * space at a time.
 *
 * <p> A MyScanner can read text from any object which implements the {@link
 * java.lang.Readable} interface.  If an invocation of the underlying
 * readable's {@link java.lang.Readable#read} method throws an {@link
 * java.io.IOException} then the MyScanner assumes that the end of the input
 ...
 *
 * <p>A MyScanner will default to interpreting numbers as decimal unless a
 * different radix has been set by using the {@link #useRadix} method. The
 * {@link #reset} method will reset the value of the MyScanner's radix to
 ...
 * formats as well as in the formats of the MyScanner's locale. A MyScanner's 
 ...
 * MyScanner's locale to the initial locale regardless of whether it was
 * previously changed.
 *
...
public final class MyScanner implements Iterator<String> {
    ...
    // A store of a position that the MyScanner may fall back to
    ...
    // Boolean indicating if this MyScanner has been closed
    private boolean closed = false;

    // The current radix used by this MyScanner
    private int radix = 10;

    // The default radix for this MyScanner
    private int defaultRadix = 10;

    // The locale used by this MyScanner
    ...
    /**
     * Constructs a <code>MyScanner</code> that returns values scanned
     * from the specified source delimited by the specified pattern.
     *
     * @param  source A character source implementing the Readable interface
     * @param pattern A delimiting pattern
     * @return A MyScanner with the specified source and pattern
     */
    ...
    /**
     * Constructs a new <code>MyScanner</code> that produces values scanned
    ...
    private void useTypeCache() {
        if (closed)
            throw new IllegalStateException("MyScanner closed");
        position = hasNextPosition;
        hasNextPattern = null;
        typeCache = null;
    }
    ...
    // Throws if the MyScanner is closed
    ...
    /**
     * Closes this MyScanner.
     *
     * <p> If this MyScanner has not yet been closed then if its underlying
     * {@linkplain java.lang.Readable readable} also implements the {@link
     * java.io.Closeable} interface then the readable's <tt>close</tt> method
     * will be invoked.  If this MyScanner is already closed then invoking this
     * method will have no effect.
     * 
     * <p>Attempting to perform search operations after a MyScanner has
     ...
     *
     * @return the last exception thrown by this MyScanner's readable
     */
     ...
     *
     * @return this MyScanner's delimiting pattern.
     */
    ...
    /**
     * Sets this MyScanner's delimiting pattern to the specified pattern.
     *
     * @param pattern A delimiting pattern
    ...
    /**
     * Sets this MyScanner's delimiting pattern to a pattern constructed from
     ...
     *
     * <p> Invoking the {@link #reset} method will set the MyScanner's delimiter
    ...
    /**
     * Returns this MyScanner's locale.
     *
     * <p>A MyScanner's locale affects many elements of its default
     * primitive matching regular expressions; see 
     * <a href= "#localized-numbers">localized numbers</a> above.
     *
     * @return this MyScanner's locale
     */
    ...
    /**
     * Sets this MyScanner's locale to the specified locale.
     *
     * <p>A MyScanner's locale affects many elements of its default
     * primitive matching regular expressions; see 
     * <a href= "#localized-numbers">localized numbers</a> above.
     *
     * <p>Invoking the {@link #reset} method will set the MyScanner's locale to
    ...
    /**
     * Returns this MyScanner's default radix.
     *
     * <p>A MyScanner's radix affects elements of its default
     * number matching regular expressions; see 
     * <a href= "#localized-numbers">localized numbers</a> above.
     *
     * @return the default radix of this MyScanner
     */
    public int radix() {
    ...
    /**
     * Sets this MyScanner's default radix to the specified radix.
     *
     * <p>A MyScanner's radix affects elements of its default
     * number matching regular expressions; see 
     * <a href= "#localized-numbers">localized numbers</a> above.
     ...
     *
     * <p>Invoking the {@link #reset} method will set the MyScanner's radix to
     * <code>10</code>.
     *
     ...
     * by this MyScanner. This method throws <code>IllegalStateException</code>
     ...
     *
     * @return  The string representation of this MyScanner
     */
    public String toString() {
        StringBuilder sb = new StringBuilder();
	sb.append("java.util.MyScanner");
    ...
    /**
     * Returns true if this MyScanner has another token in its input.
     * This method may block while waiting for input to scan.
     * The MyScanner does not advance past any input.
     *
     * @return true if and only if this MyScanner has another token
     * @throws IllegalStateException if this MyScanner is closed
    ...
    /**
     * Finds and returns the next complete token from this MyScanner.
     ...
     * specified string. The MyScanner does not advance past any input.
     *
     ...
     * @return true if and only if this MyScanner has another token matching
     ...
     * specified string.  If the match is successful, the MyScanner advances 
     ...
     * If the match is successful, the MyScanner advances past the input that 
     * matched the pattern.
     *
     * @param pattern the pattern to scan for
     * @return the next token
    ...
    /**
     * Returns true if there is another line in the input of this MyScanner.
     * This method may block while waiting for input. The MyScanner does not 
     * advance past any input.
     *
     * @return true if and only if this MyScanner has another line of input
     * @throws IllegalStateException if this MyScanner is closed
     */
    ...
    /**
     * Advances this MyScanner past the current line and returns the input
     * that was skipped.
     *
     ...
     * MyScanner advances past the input that matched and returns the string that
     * matched the pattern.
     * If no such pattern is detected in the input up to the next line
     * separator, then <code>null</code> is returned and the MyScanner's 
     ...
     * MyScanner advances past the input that matched and returns the string 
     * that matched the pattern. If no such pattern is detected then the 
     * null is returned and the MyScanner's position remains unchanged. This 
     * method may block waiting for input that matches the pattern.
     *
     * <p>A MyScanner will never search more than <code>horizon</code> code
     * points beyond its current position. Note that a match may be clipped
     * by the horizon; that is, an arbitrary match result may have been 
     * different if the horizon had been larger. The MyScanner treats the
     ...
     * the MyScanner's current position, patterns that can match a lot of
     * input (".*", for example) may cause the MyScanner to buffer a large
     * amount of input.
     *
    ...
    /**
     * Returns true if the next token in this MyScanner's input can be
     * interpreted as a boolean value using a case insensitive pattern 
     * created from the string "true|false".  The MyScanner does not
     * advance past the input that matched.
     *
     * @return true if and only if this MyScanner's next token is a valid
     *         boolean value
     * @throws IllegalStateException if this MyScanner is closed
     */
     ...
     * {@link #nextByte} method. The MyScanner does not advance past any input.
     *
     * @return true if and only if this MyScanner's next token is a valid
     *         byte value
     * @throws IllegalStateException if this MyScanner is closed
     ...
     * is the default radix of this MyScanner.
     *
     ...
     * described below. If the translation is successful, the MyScanner advances
     ...
     * {@link #nextShort} method. The MyScanner does not advance past any input.
     *
     * @return true if and only if this MyScanner's next token is a valid
     ...
     * {@link #nextInt} method. The MyScanner does not advance past any input.
     *
     * @return true if and only if this MyScanner's next token is a valid
     *         int value
     * @throws IllegalStateException if this MyScanner is closed
     ...
     * {@link #nextLong} method. The MyScanner does not advance past any input.
     *
     * @return true if and only if this MyScanner's next token is a valid
     *         long value
     * @throws IllegalStateException if this MyScanner is closed
     ...
     * method. The MyScanner does not advance past any input.
     *
     * @return true if and only if this MyScanner's next token is a valid
     *         float value
     * @throws IllegalStateException if this MyScanner is closed
     ...
     * If the translation is successful, the MyScanner advances past the input 
     * that matched.
     *
     * <p> If the next token matches the <a
     * href="#Float-regex"><i>Float</i></a> regular expression defined above
     ...
     * {@link #nextBigInteger} method. The MyScanner does not advance past any 
     * input.
     *
     * @return true if and only if this MyScanner's next token is a valid
     ...
     * the {@link #nextBigInteger} method. The MyScanner does not advance past 
     * any input.
     *
     ...
     * {@link #nextBigDecimal} method. The MyScanner does not advance past any 
     * input.
     *
     * @return true if and only if this MyScanner's next token is a valid
    ...
    /**
     * Resets this MyScanner.
     *
     * <p> Resetting a MyScanner discards all of its explicit state
     * information which may have been changed by invocations of {@link
     * #useDelimiter}, {@link #useLocale}, or {@link #useRadix}.
     *
     * <p> An invocation of this method of the form
     * <tt>MyScanner.reset()</tt> behaves in exactly the same way as the
     * invocation
     *
     * <blockquote><pre>
