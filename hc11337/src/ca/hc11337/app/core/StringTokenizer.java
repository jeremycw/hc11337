 ...
 * @since   1.5
 */
public final class StringTokenizer implements Iterator<String> {
    ...
    // The index into the buffer currently held by the StringTokenizer
    ...
    // A store of a position that the StringTokenizer may fall back to
    ...
    // Boolean indicating if this StringTokenizer has been closed
    private boolean closed = false;

    // The current radix used by this StringTokenizer
    private int radix = 10;

    // The default radix for this StringTokenizer
    private int defaultRadix = 10;

    // The locale used by this StringTokenizer
    ...
    /**
     * Constructs a <code>StringTokenizer</code> that returns values scanned
     * from the specified source delimited by the specified pattern.
     *
     * @param  source A character source implementing the Readable interface
     * @param pattern A delimiting pattern
     * @return A StringTokenizer with the specified source and pattern
     */
    private StringTokenizer(Readable source, Pattern pattern) {
        if (source == null)
    ...
    /**
     * Constructs a new <code>StringTokenizer</code> that produces values scanned
     * from the specified source.
     *
     * @param  source A character source implementing the {@link Readable}
     *         interface
     */
    public StringTokenizer(Readable source) {
     ...
     */
    public StringTokenizer(InputStream source) {
     ...
     *         does not exist
     */
    public StringTokenizer(InputStream source, String charsetName) {
     ...
     */
    public StringTokenizer(File source) 
     ...
     *         not found
     */
    public StringTokenizer(File source, String charsetName) 
        throws FileNotFoundException 
    {
        this((ReadableByteChannel)(new FileInputStream(source).getChannel()), 
             charsetName);
     ...
     */
    public StringTokenizer(ReadableByteChannel source) {
     ...
     *         does not exist
     */
    public StringTokenizer(ReadableByteChannel source, String charsetName) {
        this(makeReadable(source, charsetName), WHITESPACE_PATTERN);
    }
    ...
    private void useTypeCache() {
        if (closed)
            throw new IllegalStateException("StringTokenizer closed");
        position = hasNextPosition;
        hasNextPattern = null;
        typeCache = null;
    }
    ...
    // Throws if the StringTokenizer is closed
    ...
    /**
     * Closes this StringTokenizer.
     *
     * <p> If this StringTokenizer has not yet been closed then if its underlying
     * {@linkplain java.lang.Readable readable} also implements the {@link
     * java.io.Closeable} interface then the readable's <tt>close</tt> method
     * will be invoked.  If this StringTokenizer is already closed then invoking this
     * method will have no effect.
     * 
     * <p>Attempting to perform search operations after a StringTokenizer has
     ...
     * <code>StringTokenizer</code>'s underlying <code>Readable</code>. This method
     * returns <code>null</code> if no such exception exists.
     *
     * @return the last exception thrown by this StringTokenizer's readable
     */
    ...
    /**
     * Returns the <code>Pattern</code> this <code>StringTokenizer</code> is currently
     * using to match delimiters.
     *
     * @return this StringTokenizer's delimiting pattern.
     */
    ...
    /**
     * Sets this StringTokenizer's delimiting pattern to the specified pattern.
     *
     * @param pattern A delimiting pattern
     * @return this StringTokenizer
     */
    public StringTokenizer useDelimiter(Pattern pattern) {
        delimPattern = pattern;
        return this;
    }

    /**
     * Sets this StringTokenizer's delimiting pattern to a pattern constructed from
     ...
     * @return this StringTokenizer
     */
    public StringTokenizer useDelimiter(String pattern) {
        delimPattern = patternCache.forName(pattern);
        return this;
    }

    /**
     * Returns this StringTokenizer's locale.
     *
     * <p>A StringTokenizer's locale affects many elements of its default
     * primitive matching regular expressions; see 
     * <a href= "#localized-numbers">localized numbers</a> above.
     *
     * @return this StringTokenizer's locale
     */
    ...
    /**
     * Sets this StringTokenizer's locale to the specified locale.
     *
     * <p>A StringTokenizer's locale affects many elements of its default
     * primitive matching regular expressions; see 
     * <a href= "#localized-numbers">localized numbers</a> above.
     ...
     * @return this StringTokenizer
     */
    public StringTokenizer useLocale(Locale locale) {
    ...
    /**
     * Returns this StringTokenizer's default radix.
     *
     * <p>A StringTokenizer's radix affects elements of its default
     * number matching regular expressions; see 
     * <a href= "#localized-numbers">localized numbers</a> above.
     *
     * @return the default radix of this StringTokenizer
     */
    public int radix() {
    ...
    /**
     * Sets this StringTokenizer's default radix to the specified radix.
     *
     * <p>A StringTokenizer's radix affects elements of its default
     * number matching regular expressions; see 
     * <a href= "#localized-numbers">localized numbers</a> above.
     ...
     */
    public StringTokenizer useRadix(int radix) {
     ...
     * by this StringTokenizer. This method throws <code>IllegalStateException</code>
     * if no match has been performed, or if the last match was
     * not successful.
     *
     * <p>The various <code>next</code>methods of <code>StringTokenizer</code>
    ...
    /**
     * <p>Returns the string representation of this <code>StringTokenizer</code>. The
     * string representation of a <code>StringTokenizer</code> contains information
     * that may be useful for debugging. The exact format is unspecified.
     *
     * @return  The string representation of this StringTokenizer
     */
    public String toString() {
        StringBuilder sb = new StringBuilder();
	sb.append("java.util.StringTokenizer");
    ...
    /**
     * Returns true if this StringTokenizer has another token in its input.
     * This method may block while waiting for input to scan.
     * The StringTokenizer does not advance past any input.
     *
     * @return true if and only if this StringTokenizer has another token
     * @throws IllegalStateException if this StringTokenizer is closed
    ...
    /**
     * Finds and returns the next complete token from this StringTokenizer.
     ...
     * specified string. The StringTokenizer does not advance past any input.
     *
     ...
     * @return true if and only if this StringTokenizer has another token matching
     ...
     * specified string.  If the match is successful, the StringTokenizer advances 
     ...
     * If the match is successful, the StringTokenizer advances past the input that 
     * matched the pattern.
     *
     * @param pattern the pattern to scan for
     * @return the next token
    ...
    /**
     * Returns true if there is another line in the input of this StringTokenizer.
     * This method may block while waiting for input. The StringTokenizer does not 
     * advance past any input.
     *
     * @return true if and only if this StringTokenizer has another line of input
     * @throws IllegalStateException if this StringTokenizer is closed
     */
    ...
    /**
     * Advances this StringTokenizer past the current line and returns the input
     * that was skipped.
     *
     ...
     * StringTokenizer advances past the input that matched and returns the string that
     * matched the pattern.
     * If no such pattern is detected in the input up to the next line
     * separator, then <code>null</code> is returned and the StringTokenizer's 
     ...
     * StringTokenizer advances past the input that matched and returns the string 
     * that matched the pattern. If no such pattern is detected then the 
     * null is returned and the StringTokenizer's position remains unchanged. This 
     * method may block waiting for input that matches the pattern.
     *
     * <p>A StringTokenizer will never search more than <code>horizon</code> code
     * points beyond its current position. Note that a match may be clipped
     * by the horizon; that is, an arbitrary match result may have been 
     * different if the horizon had been larger. The StringTokenizer treats the
     ...
     * the StringTokenizer's current position, patterns that can match a lot of
     * input (".*", for example) may cause the StringTokenizer to buffer a large
     * amount of input.
     *
     ...
     * @throws IllegalStateException if this StringTokenizer is closed
     */
    public StringTokenizer skip(Pattern pattern) {
        ensureOpen();
        if (pattern == null)
            throw new NullPointerException();
        clearCaches();
     ...
     * @throws IllegalStateException if this StringTokenizer is closed
     */
    public StringTokenizer skip(String pattern) {
    ...
    /**
     * Returns true if the next token in this StringTokenizer's input can be
     * interpreted as a boolean value using a case insensitive pattern 
     * created from the string "true|false".  The StringTokenizer does not
     * advance past the input that matched.
     *
     * @return true if and only if this StringTokenizer's next token is a valid
     *         boolean value
     * @throws IllegalStateException if this StringTokenizer is closed
     */
     ...
     * {@link #nextByte} method. The StringTokenizer does not advance past any input.
     *
     * @return true if and only if this StringTokenizer's next token is a valid
     *         byte value
     * @throws IllegalStateException if this StringTokenizer is closed
     ...
     * is the default radix of this StringTokenizer.
     *
     ...
     * described below. If the translation is successful, the StringTokenizer advances
     ...
     * {@link #nextShort} method. The StringTokenizer does not advance past any input.
     *
     * @return true if and only if this StringTokenizer's next token is a valid
     ...
     * {@link #nextInt} method. The StringTokenizer does not advance past any input.
     *
     * @return true if and only if this StringTokenizer's next token is a valid
     *         int value
     * @throws IllegalStateException if this StringTokenizer is closed
     ...
     * {@link #nextLong} method. The StringTokenizer does not advance past any input.
     *
     * @return true if and only if this StringTokenizer's next token is a valid
     *         long value
     * @throws IllegalStateException if this StringTokenizer is closed
     ...
     * method. The StringTokenizer does not advance past any input.
     *
     * @return true if and only if this StringTokenizer's next token is a valid
     *         float value
     * @throws IllegalStateException if this StringTokenizer is closed
     ...
     * If the translation is successful, the StringTokenizer advances past the input 
     * that matched.
     *
     * <p> If the next token matches the <a
     * href="#Float-regex"><i>Float</i></a> regular expression defined above
     ...
     * {@link #nextBigInteger} method. The StringTokenizer does not advance past any 
     * input.
     *
     * @return true if and only if this StringTokenizer's next token is a valid
     ...
     * the {@link #nextBigInteger} method. The StringTokenizer does not advance past 
     * any input.
     *
     ...
     * {@link #nextBigDecimal} method. The StringTokenizer does not advance past any 
     * input.
     *
     * @return true if and only if this StringTokenizer's next token is a valid
